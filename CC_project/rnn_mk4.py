...
model.add(layers.MultiHeadAttention(num))
...
history = model.fit(
    ...
    #batch_size=2, 
    steps_per_epoch=1750,  # about 1730 total if i did calculations correctly
    epochs=60, 
    validation_steps = 220, # about 220
...
save_path = f"/n/eddy_lab/users/rangerkuang/CC_project/uq_heckpoints/ckp_{date}/architecture"
